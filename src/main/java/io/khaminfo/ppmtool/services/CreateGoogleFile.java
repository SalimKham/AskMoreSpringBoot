...
public class CreateGoogleFile {
    ...
    public static void main(String[] args) throws IOException {
        ...
        java.io.File uploadFile = new java.io.File("/home/salim/Downloads/Array_List_in_Java.pdf");
 
        // Create Google File:
 
        File googleFile = createGoogleFile("1Cm9asmUPETWfqPpzoCAjjfFPYKyOpn80", "application/pdf", "file.pdf", uploadFile);
